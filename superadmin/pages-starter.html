...
<!-- Mirrored from themes.getappui.com/techui/layouts/pages-starter.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Feb 2026 07:40:54 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Starter  | TechUI - Responsive Bootstrap 5 Admin Dashboard</title>
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-between align-items-center py-2">
                                    ...
                                    <ol class="breadcrumb d-lg-flex d-none mb-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Starter</a></li>
                                    </ol>
                                </div>
                            </div>
                        </div>
