...
<!-- Mirrored from themes.getappui.com/techui/layouts/auth-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Feb 2026 07:41:00 GMT -->
                        ...
                        <div class="col-xl-7 col-lg-6">
                            <div class="d-flex flex-column p-4">
                                ...
                                <div class="flex-grow-1 d-flex flex-column align-items-center justify-content-center">
                                    <div class="w-100">
                                        <div class="">
                                            <h4 class="font-20">Free Sign Up</h4>
                                        ...
                                        <form action="#" id="registerForm">
                                            ...
                                            <div class="mb-0 d-grid text-center">
                                                <button class="btn btn-dark fw-semibold" type="submit">Sign Up</button>
                                            </div>
                                        </form>
