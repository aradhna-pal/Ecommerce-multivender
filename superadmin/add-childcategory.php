            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center py-2">
                    ...
                    <ol class="breadcrumb d-lg-flex d-none mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="javascript: void(0);"> Add Child Category </a></li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="#" id="addchildCategoryForm">
                            <!-- Content -->
                            <div class="mb-3">
                                <label class="form-label" for="parentId">Select Parent Category</label>

                                <select class="form-control" id="parentId" name="parentId">
                                    <option value="">Select Category</option>
                                    <!-- Dynamic options yaha JS se aayenge -->
                                </select>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="parentId">Select Parent Category</label>
                            ...
                            <!-- Child CATEGORY NAME -->
                            <div class="mb-3">
                                <label class="form-label" for="childcategoryName">Child Category Name</label>
                                <input type="text" class="form-control" id="childcategoryName" name="childcategoryName"
...
.form-check-input:focus {
    box-shadow: none;
            ...
            <div class="d-flex justify-content-end mb-3">
                ...
                <button type="button" class="btn btn-dark" id="addchildCategoryBtn">
                    Add Child Category
                </button>
            </div>
