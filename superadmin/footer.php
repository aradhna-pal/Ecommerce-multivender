    ...
    <div class="offcanvas-body p-3 h-100" data-simplebar>
        ...
        <div>
            ...
            <div class="d-flex gap-2 mb-2">
                ...
                <div class="form-check form-radio w-50">
                    <input class="form-check-input" type="radio" name="data-sidenav-size" id="sidenav-size-overlay"
                        value="overlay">
...
<!-- Mirrored from themes.getappui.com/techui/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Feb 2026 07:40:44 GMT -->
