...
<!-- Mirrored from themes.getappui.com/techui/layouts/auth-logout.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Feb 2026 07:41:00 GMT -->
<head>
    <meta charset="utf-8" />
    <title>Log Out  | TechUI - Responsive Bootstrap 5 Admin Dashboard</title>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                                ...
                                <div class="flex-grow-1 d-flex flex-column align-items-center justify-content-center">
                                    <div class="w-100">
                                        ...
                                        <div class="d-flex justify-content-center m-auto">
                                            <img src="assets/logout-c5477a9d.svg" alt="" width="140" class="img-fluid mx-auto">
                                        </div>
                                    </div>
                                </div>
                ...
                <!-- end card -->
                <p class="text-muted text-center font-16 mb-5">Back To <a href="login.php" class="text-dark ms-1">Sign In</a></p>
...
<!-- Mirrored from themes.getappui.com/techui/layouts/auth-logout.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Feb 2026 07:41:01 GMT -->
</html>
