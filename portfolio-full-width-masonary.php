...
<!-- Mirrored from themes.pixelstrap.net/kartify/template/portfolio-full-width-masonary.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Mar 2026 10:23:18 GMT -->
<head>
            ...
            <div class="breadcrumb-contain">
                ...
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active">Portfolio full masonary</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="m-p-g">
                <div class="grid m-p-g__thumbs row g-sm-4 g-3 grid-portfolio-box portfolio-images-box"
                    ...
                    <div class="grid-sizer col-xl-3 col-lg-4 col-sm-6"></div>
                    <div class="grid-item fashion col-xl-3 col-lg-4 col-sm-6 ratio_57">
                    ...
                    <div class="grid-item electronic col-xl-3 col-lg-4 col-sm-6 ratio_62">
                        <div class="portfolio-box">
                            <a href="#!" class="img-box m-p-g__thumbs-img"
                    ...
                    <div class="grid-item grocery col-xl-3 col-lg-4 col-sm-6 ratio_72">
                        <div class="portfolio-box">
                            <a href="#!" class="img-box m-p-g__thumbs-img"
                    ...
                    <div class="grid-item fashion col-xl-3 col-lg-4 col-sm-6 ratio_82">
                        <div class="portfolio-box">
                            <a href="#!" class="img-box m-p-g__thumbs-img"
                    ...
                    <div class="grid-item grocery col-xl-3 col-lg-4 col-sm-6 ratio_89">
                        <div class="portfolio-box">
                            <a href="#!" class="img-box m-p-g__thumbs-img"
                    ...
                    <div class="grid-item fashion col-xl-3 col-lg-4 col-sm-6 ratio_100">
                        <div class="portfolio-box">
                            <a href="#!" class="img-box m-p-g__thumbs-img"
                                data-full="../assets/images/inner-page/portfolio/2.jpg">
                                <img src="../assets/images/inner-page/portfolio/2.jpg" alt="portfolio"
                    ...
                    <div class="grid-item electronic col-xl-3 col-lg-4 col-sm-6 ratio_50">
                        <div class="portfolio-box">
                            <a href="#!" class="img-box m-p-g__thumbs-img"
                    ...
                    <div class="grid-item electronic col-xl-3 col-lg-4 col-sm-6 ratio_60">
                        <div class="portfolio-box">
                            <a href="#!" class="img-box m-p-g__thumbs-img"
                                data-full="../assets/images/inner-page/portfolio/1.jpg">
                                <img src="../assets/images/inner-page/portfolio/1.jpg" alt="portfolio"
                    ...
                    <div class="grid-item grocery col-xl-3 col-lg-4 col-sm-6 ratio_45">
                        <div class="portfolio-box">
                            <a href="#!" class="img-box m-p-g__thumbs-img"
                                data-full="../assets/images/inner-page/portfolio/2.jpg">
                                <img src="../assets/images/inner-page/portfolio/2.jpg" alt="portfolio"
                    ...
                    <div class="grid-item fashion col-xl-3 col-lg-4 col-sm-6 ratio_89">
                        <div class="portfolio-box">
                            <a href="#!" class="img-box m-p-g__thumbs-img"
                                data-full="../assets/images/inner-page/portfolio/3.jpg">
                                <img src="../assets/images/inner-page/portfolio/3.jpg" alt="portfolio"
                    ...
                    <div class="grid-item grocery col-xl-3 col-lg-4 col-sm-6 ratio_62">
                        <div class="portfolio-box">
                            <a href="#!" class="img-box m-p-g__thumbs-img"
                                data-full="../assets/images/inner-page/portfolio/4.jpg">
                                <img src="../assets/images/inner-page/portfolio/4.jpg" alt="portfolio"
