                    ...
                    <div class="card-body">
                        <form id="addArticleForm">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="articleImage">Image <span class="text-danger">*</span></label>
                            ...
                            <div class="d-flex justify-content-end mt-3">
                                <button type="button" class="btn btn-dark" id="addArticleBtn">Add Article</button>
                            </div>
                        </form>
                    </div>
                </div>
