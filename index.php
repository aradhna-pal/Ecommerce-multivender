...
<!-- Mirrored from demo.smartaddons.com/templates/html/maxshop/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Mar 2026 12:18:55 GMT -->
								...
								<ul class="top-link list-inline">
									...
									<li class="form-group languages-block ">
										<form action="https://demo.smartaddons.com/templates/html/maxshop/index.html" method="post" enctype="multipart/form-data" id="bt-language">
											...
											<ul class="dropdown-menu">
												<li><a href="index-2.html"><img class="image_flag lazyload" data-sizes="auto" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="image/demo/flags/gb.png" alt="English" title="English" /> English </a></li>
												<li> <a href="index-2.html"> <img class="image_flag lazyload" data-sizes="auto" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="image/demo/flags/lb.png" alt="Arabic" title="Arabic" /> Arabic </a> </li>
											</ul>
										</form>
									</li>
								</ul>
				...
				<div class="container">
					<div class="row">
						...
						<div class="navbar-logo col-md-3 col-sm-4 col-xs-10">
						   <a href="index-2.html"><img class="lazyload" data-sizes="auto" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="image/demo/logos/theme_logo.png" title="Your Store" alt="Your Store" /></a>
						</div>
							...
							<div class="module ">
								<div class="content-block-footer">
									<div class="footer-logo">
										<a href="index-2.html"><img  class="lazyload img-responsive" data-sizes="auto" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="image/demo/logos/theme_logo.png" title="Your Store" alt="Your Store" /></a>
									</div>
	...
	<div id="sp-cpanel" class="sp-delay">
		...
		<div id="sp-cpanel_settings">
			...
			<div class="reset-group">
				<a href="index-2.html" class="btn btn-success " onclick="ResetAll()">Reset</a>
			</div>
...
<!-- Mirrored from demo.smartaddons.com/templates/html/maxshop/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Mar 2026 12:19:20 GMT -->
</html>